...
public class FrameGame extends BaseChildFrame implements ActionListener, KeyListener {
    ...
    private void initComponents() {
        ...
        jbtnLeft.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/left.png"))); // NOI18N
        jbtnLeft.setName("jbtnLeft"); // NOI18N
        jbtnLeft.addActionListener(this);

        jbtnUp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/up.png"))); // NOI18N
        jbtnUp.setName("jbtnUp"); // NOI18N
        jbtnUp.addActionListener(this);

        jbtnRight.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/right.png"))); // NOI18N
        jbtnRight.setName("jbtnRight"); // NOI18N
        jbtnRight.addActionListener(this);

        jbtnDown.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/down.png"))); // NOI18N
        ...
        jbtnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/save.png"))); // NOI18N
        ...
        jbtnExit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kz/app/mazaman/images/exit.png"))); // NOI18N
    ...
    private void jbtnUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnUpActionPerformed
        moveObject(MovingDirection.UP, GameObjectType.MAZAMAN);
    ...
    private void jbtnLeftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnLeftActionPerformed
        moveObject(MovingDirection.LEFT, GameObjectType.MAZAMAN);
    ...
    private void jbtnDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDownActionPerformed
        moveObject(MovingDirection.DOWN, GameObjectType.MAZAMAN);
    ...
    private void jbtnRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRightActionPerformed
        moveObject(MovingDirection.RIGHT, GameObjectType.MAZAMAN);
